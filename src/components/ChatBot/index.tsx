...
const responses: Record<string, string> = {
  ...
  function sendMessage(text: string) {
    ...
    const botMsg = { text: responses[text] || "Hmm... Ainda estou aprendendo sobre isso. Tente me perguntar outra coisa!", isUser: false };
  ...
  return (
    <ChatContainer className="container">
      ...
      <p className="text-center">Escolha um tema para começar ou inicie uma conversa enviando uma mensagem.</p>
